...
// double Ether::m_a = 0.0;
// double Ether::m_b = 0.0;
// double Ether::m_quickTurn = 0.0;

// VelocityPair::VelocityPair(double l, double r) {

// }

// Ether::Ether(TalonSRX * leftMotor1, TalonSRX * leftMotor2,
...
// void Ether::setAB(double a, double b) {
// 	m_a = a;
// 	m_b = b;
// }

// void Ether::setQuickturn(double q) {
// 	m_quickTurn = q;
// }

// VelocityPair Ether::calculate(double mag, double rot,
// 		double deadband) {
// 	if (abs(mag) < deadband) {
// 		mag = 0;
// 	}
...
// double Ether::etherL(double fwd, double rcw, double a, double b) {
// 	return fwd + b * rcw * (1 - fwd);
// }

// double Ether::etherR(double fwd, double rcw, double a, double b) {
